export default class GenderInput extends HTMLElement {
  ...
  constructor(prefix?: string) {
    ...
    select.name = "gender";
    const select_n = document.createElement("option");
    select_n.value = "M";
    select_n.textContent = "Choose...";
    select_n.selected = true;
    const select_m = document.createElement("option");
    select_m.value = "M";
    select_m.textContent = "Male";
    const select_f = document.createElement("option");
    select_f.value = "F";
    select_f.textContent = "Female";
    const select_o = document.createElement("option");
    select_o.value = "O";
