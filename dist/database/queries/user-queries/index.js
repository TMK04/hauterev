...
exports.deleteUserByUsername =
  ...
  exports.selectUserAsUser =
  exports.selectUserByUsername =
  exports.selectPasswordHashByUsername =
  exports.insertUser =
    void 0;
...
// * Helpers * //
// ----------- //
const userTable = () => (0, database_1.default)("user");
const user = (username) => userTable().where({ username });
// ----------- //
// * Queries * //
// ----------- //
// *--- Insert ---* //
const insertUser = (insert_user) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return userTable().insert(insert_user);
  });
exports.insertUser = insertUser;
// *--- Select ---* //
const selectPasswordHashByUsername = (username) =>
  user(username).select("password_hash");
