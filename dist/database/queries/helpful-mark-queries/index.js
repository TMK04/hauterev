...
// ----------- //
// *--- Insert ---* //
const insertHelpfulMark = (helpful_mark) => helpfulMarkTable().insert(helpful_mark);
exports.insertHelpfulMark = insertHelpfulMark;
// *--- Select ---* //
const selectHelpfulMarksHelpfulCount = () => helpfulMarkTable()
    .select("review_id")
    .count({ helpful_count: "*" })
    .groupBy("review_id")
    .as("helpful_marks");
...
// *--- Delete ---* //
const deleteHelpfulMark = (helpful_mark) => helpfulMarkTable().del().where(helpful_mark);
