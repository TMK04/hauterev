...
exports.deleteBookmarkByRestaurantIDnUsername =
  exports.selectBookmarksByUsername =
  exports.insertBookmark =
    void 0;
...
// *--- Select ---* //
const selectBookmarksByUsername = (username) =>
  bookmarkTable().select().where({ username });
exports.selectBookmarksByUsername = selectBookmarksByUsername;
// *--- Delete ---* //
const deleteBookmarkByRestaurantIDnUsername = (restaurant_id, username) =>
