...
exports.isEmpty =
  exports.isDefined =
  exports.simpleNumberNullInvalid =
  exports.simpleNumberValidate =
  exports.simpleStringNullInvalid =
  exports.simpleStringRawDefaultInvalid =
  exports.simpleStringValidate =
  exports.nullInvalid =
  exports.rawDefaultInvalid =
  exports.defaultInvalid =
  exports.validate =
  exports.catchNext =
    void 0;
...
// *--- Extensions ---* //
const defaultInvalid = (data, key, validateFn, default_value) =>
  validate(data, key, validateFn, true, default_value);
exports.defaultInvalid = defaultInvalid;
const rawDefaultInvalid = (body, key, validateFn) =>
  (0, exports.defaultInvalid)(body, key, validateFn, raw_default_1.default);
exports.rawDefaultInvalid = rawDefaultInvalid;
const nullInvalid = (query, key, validateFn) =>
  (0, exports.defaultInvalid)(query, key, validateFn, null);
...
// *--- Implementations ---* //
const simpleStringValidate = (data, key) =>
  validate(data, key, simpleStringValidateFn);
exports.simpleStringValidate = simpleStringValidate;
const simpleStringRawDefaultInvalid = (body, key) =>
  (0, exports.rawDefaultInvalid)(body, key, simpleStringValidateFn);
exports.simpleStringRawDefaultInvalid = simpleStringRawDefaultInvalid;
const simpleStringNullInvalid = (query, key) =>
  (0, exports.nullInvalid)(query, key, simpleStringValidateFn);
exports.simpleStringNullInvalid = simpleStringNullInvalid;
const simpleNumberValidate = (data, key) =>
  validate(data, key, simpleNumberValidateFn);
exports.simpleNumberValidate = simpleNumberValidate;
const simpleNumberNullInvalid = (query, key) =>
  (0, exports.nullInvalid)(query, key, simpleNumberValidateFn);
