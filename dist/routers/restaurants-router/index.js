...
// ----------- //
// *--- validate variants ---* //
const restaurant_regions = ["North", "South", "East", "West", "Central"];
const nullInvalidRegion = (query) =>
  (0, helpers_1.nullInvalid)(
    query,
    "region",
    (v) => restaurant_regions.includes(v) && v
  );
exports.nullInvalidRegion = nullInvalidRegion;
const nullInvalidOpeningHours = (query) =>
  (0, helpers_1.nullInvalid)(query, "opening_hours", (v) => {
    if (!v) return;
    v = parseInt(v, 2);
...
// ---------------- //
// *--- GET ---* //
restaurants_router.get("/", ({ query }, res, next) =>
  (0, helpers_1.catchNext)(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        res.json(
          yield (0, queries_1.selectRestaurants)({
            search,
            rating,
            region,
            opening_hours,
...
restaurants_router.get(`/:id`, ({ params }, res, next) =>
  (0, helpers_1.catchNext)(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const { id } = params;
        const restaurant_result = yield (0, queries_1.selectRestaurantByID)(
          +id
        );
