...
// -------------------- //
// *--- GET ---* //
router_1.default.get(`/:id`, ({ params }, res, next) => (0, helpers_1.catchNext)(() => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = params;
    const restaurant_result = yield (0, schemas_1.selectRestaurantByID)(+id);
