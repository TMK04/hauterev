...
// *--- GET ---* //
review_router.get("/", ({ params }, res, next) => (0, helpers_1.catchNext)(() => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = params;
    const review_result = yield (0, schemas_1.selectReviewByID)(+id);
    const review = review_result[0];
    if (!review)
        throw new Errors_1.NotFoundError("Review", id);
    res.json(review);
}), next));
