  ...
  (0, helpers_1.catchNext)(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        queries_1.selectPasswordHashByUsername)(username);
...
// *--- GET ---* //
__1.default.get("/:username", ({ params }, res, next) =>
  (0, helpers_1.catchNext)(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const { username } = params;
      ...
      () =>
        __awaiter(void 0, void 0, void 0, function* () {
          ...
          if ((0, helpers_1.isDefined)(new_password))
            update_user.password_hash = yield (0, __1.salted_hash)(
              (0, __1.validatePassword)(body, "new_password")
            );
          if ((0, helpers_1.isDefined)(email))
            update_user.email = (0, helpers_1.simpleStringValidate)(
              body,
              "email"
            );
          if ((0, helpers_1.isDefined)(last_name))
            update_user.last_name = (0, helpers_1.simpleStringValidate)(
              body,
              "last_name"
            );
          if ((0, helpers_1.isDefined)(first_name))
            update_user.first_name = (0,
            helpers_1.simpleStringRawDefaultInvalid)(body, "first_name");
          if ((0, helpers_1.isDefined)(mobile_number))
            update_user.mobile_number = (0, __1.rawDefaultInvalidMobileNumber)(
              body
            );
          if ((0, helpers_1.isDefined)(address))
            update_user.address = (0, helpers_1.simpleStringRawDefaultInvalid)(
              body,
              "address"
            );
          ...
          yield (0,
          queries_1.updateUserByUsername)(params.username, update_user);
          res.sendStatus(205);
        }),
      next
    )
