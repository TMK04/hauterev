...
const validateRating = (body) =>
  (0, helpers_1.validate)(
    body,
    "rating",
    (v) => typeof v === "number" && v >= 1 && v <= 5 && v - (v % 0.5)
  );
 ...
 */
const rejectUnauthorized = ({ params }, _, next) =>
  (0, helpers_1.catchNext)(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
        const review_id_result = yield (0,
        queries_1.selectReviewIDByIDnUsername)(+params.id, params.username);
...
// ---------------------------- //
__1.default.post("/:username/reviews", ({ body, params }, res, next) =>
  (0, helpers_1.catchNext)(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
...
// *--- PATCH ---* //
__1.default.patch("/:username/reviews/:id", ({ body, params }, res, next) =>
  (0, helpers_1.catchNext)(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        if ((0, helpers_1.isDefined)(title))
          update_review.title = (0, helpers_1.simpleStringValidate)(
            body,
            "title"
          );
        if ((0, helpers_1.isDefined)(description))
          update_review.description = (0, helpers_1.simpleStringValidate)(
            body,
            "description"
          );
        if ((0, helpers_1.isDefined)(image_url))
          update_review.image_url = (0, helpers_1.simpleStringValidate)(
            body,
            "image_url"
          );
        ...
        yield (0,
        queries_1.updateReviewByID)(+params.id, update_review, new Date());
        res.sendStatus(205);
      }),
    next
  )
...
// *--- DELETE ---* //
__1.default.delete("/:username/reviews/:id", ({ params }, res, next) =>
  (0, helpers_1.catchNext)(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
