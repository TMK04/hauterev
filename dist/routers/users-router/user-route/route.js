...
// -------------------- //
// *--- GET ---* //
router_1.default.get("/:username", ({ params }, res, next) =>
  (0, helpers_2.catchNext)(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!user_profile) throw new Errors_1.NotFoundError("User", username);
...
// *--- PATCH ---* //
router_1.default.patch(
  "/:username",
  helpers_3.rejectUnauthenticated,
      ...
      () =>
        __awaiter(void 0, void 0, void 0, function* () {
          ...
          if ((0, helpers_2.isDefined)(new_password))
            update_user.password_hash = yield (0, helpers_1.salted_hash)(
              (0, helpers_1.validatePassword)(body, "new_password")
            );
          if ((0, helpers_2.isDefined)(email))
            update_user.email = (0, helpers_2.simpleStringValidate)(
              body,
              "email"
            );
          if ((0, helpers_2.isDefined)(last_name))
            update_user.last_name = (0, helpers_2.simpleStringValidate)(
              body,
              "last_name"
            );
          if ((0, helpers_2.isDefined)(first_name))
            update_user.first_name = (0,
            helpers_2.simpleStringRawDefaultInvalid)(body, "first_name");
          if ((0, helpers_2.isDefined)(mobile_number))
            update_user.mobile_number = (0,
            helpers_1.rawDefaultInvalidMobileNumber)(body);
          if ((0, helpers_2.isDefined)(address))
            update_user.address = (0, helpers_2.simpleStringRawDefaultInvalid)(
              body,
              "address"
            );
          ...
          yield (0,
          schemas_1.updateUserByUsername)(params.username, update_user);
          res.sendStatus(205);
        }),
      next
    )
